...
const CarRentalList = () => {
  ...
  useEffect(() => {
    async function fetchData(){
      try {
        const response = await axios.post("https://autofinder-backend.vercel.app/api/carRentalAd/getAll")
  ...
  return ( 
    <div className="CarRentalList">
      ...
      <div className="underHeadingCont">
        <aside className="filterCont">Filter Goes here</aside>
            ...
            data.map((item) => (
              ...
              >
                ...
                <div className="detailHolder">
                  ...
                  <p> {item.city}</p>
                  <p>
                    {item.mileage} km | {item.carType} |{" "}
                    {item.engineType} | {item.driverAvailability}{" "}
                  </p>
                  <p>
                    {" "}
