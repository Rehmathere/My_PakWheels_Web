...
const Bike_verifyPayment = () => {
  ...
  return (
    <div className="VerifyPayment">
      <h1>Bike Verify Payment</h1>
      <div className="importantNoticeHolder">
        <p>
          <span>⚠️</span> <strong>NOTE: </strong> Upload Your Bike Package Payment Screen Shot !
        </p>
      </div>
      <form>
...
export default Bike_verifyPayment;
